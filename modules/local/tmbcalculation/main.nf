process TMB_CALCULATE {
    ...
    conda "conda-forge::python=3.10 conda-forge::pandas=2.0.3 conda-forge::numpy=1.25.1 conda-forge::matplotlib=3.6.3 conda-forge::seaborn=0.12.2 bioconda::pyranges=0.1.4"
